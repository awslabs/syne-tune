...
def get_final_model(original_model, new_model_config):
    ...
    for name, module in new_model.bert.named_modules():
        if isinstance(module, nn.Linear):
            ...
            new_state_dict['weight'] = original_layer['weight'][:weight_shape[0], :weight_shape[1]]
...
if __name__ == "__main__":
    ...
    config = BertConfig(num_hidden_layers=6, num_attention_heads=6, intermediate_size=1024)
